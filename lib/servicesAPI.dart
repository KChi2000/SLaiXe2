...
class servicesAPI {
  ...
  static final API_HangHoa =
      'https://api-hanghoa.nguyencongtuyen.sonphat.dev/api/';
  ...
  static final API_DoanhNghiepVanTai =
      backend_url + 'be_api/doanhnghiepvantai/';
...
class apilenh {
  ...
  static final apidsdacaplenh =
      backend_url + qllenhurl + 'danh-sach-lenh-da-cap-cho-lai-xe';
  static final apidslenhdangthuchien =
      backend_url + qllenhurl + 'danh-sach-lenh-dang-thuc-hien';
  static final apidslenhdahoanthanh =
      backend_url + qllenhurl + 'danh-sach-lenh-da-hoan-thanh';
  static final apidslenhkhonghoanthanh =
      backend_url + qllenhurl + 'danh-sach-lenh-khong-hoan-thanh';
  static final apidsluongtuyen = backend_url +
      'ql-thong-tin/api/QuanLyThongTin/danh-sach-luong-tuyen-cap-tuyen';
}
...
class apiSuaKeHoach {
  static String apidsxedukien(String idkehoach) {
    final url = backend_url +
        qllenhurl +
        'Danh-Sach-Xe-Du-Kien-Theo-Ke-Hoach?IdKeHoach=$idkehoach';
    return url;
  }
  ...
  static String apidslaixedukien(String idkehoach) {
    final url = backend_url +
        qllenhurl +
        'Danh-Sach-Lai-Xe-Du-Kien-Theo-Ke-Hoach?IdKeHoach=$idkehoach';
    return url;
  }

  static String apidchitietkehoach(
      String tungay, String denngay, String idkehoach) {
    final url = backend_url +
        qllenhurl +
        'Chi-Tiet-Ke-Hoach?TuNgay=$tungay&DenNgay=$denngay&idKeHoach=$idkehoach';
    return url;
  }
